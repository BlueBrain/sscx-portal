...
function SvgBrainRegions(props) {
  return (
    <svg
      id="brain_regions_svg__Layer_1"
      x={0}
      y={0}
    ...
    >
      <style>
        {
          '.brain_regions_svg__st3{fill:#050a30}.brain_regions_svg__st6,.brain_regions_svg__st7{fill:none}.brain_regions_svg__st7{stroke:#fff;stroke-width:1.6667;stroke-miterlimit:10}.brain_regions_svg__st8{enable-background:new}.brain_regions_svg__st9{fill:#fff}.brain_regions_svg__st10{fill:#7ca4dc}'
        }
      </style>
      <path
        ...
        fill="#0b0780"
      />
      <g id="brain_regions_svg__Plain_background">
        <g id="brain_regions_svg__Brainregionsback">
          <path
          ...
          />
          <linearGradient
            id="brain_regions_svg__SVGID_1_"
          ...
          <path
            ...
            fill="url(#brain_regions_svg__SVGID_1_)"
          />
          <path
      ...
      <g id="brain_regions_svg__Fill">
        <path
          id="brain_regions_svg__S1Trfill"
        ...
        />
        <g id="brain_regions_svg__S1FLfilll">
          <path
            className="brain_regions_svg__st6"
            d="M237.4 82.6V83.5c0 2.3-.2 4.8-.5 7.2-.2 2.2-.3 4.2-.5 6.3 0 0 0 .3-.2.8-2 19.2-6.3 36.5-16 33-.3 0-.8-.2-1.2-.5-.8-.3-1.7-.8-2.5-1.3-1.3-.7-2.5-1.3-3.3-1.8s-1.5-.8-1.5-.8c-3.3-2.2-6.3-4.5-8.8-6.8-2.5-2.5-4.5-5-6.2-7.7-3-5-4.2-10.5-4.2-16.8v-1.3c0-.5 0-1.2.2-1.8v-1c0-.7.2-1.3.2-1.8v-.7c0-.7.2-1 .2-1 1.8-12.8 7-33.3 10.7-46.8 3.2-11.8 18.7-15 26-5.2.8 1.2 1.7 2.3 2.3 3.5v.2c.6 1.4 4 22.3 5.3 43.4zM147.1 291.6l-35.2-5.5c3-1.8 5-5 5-9.7 0-5.8.5-14.2 1.3-23.7l8 3.2c8.8 3.5 18.2 5.3 27.7 5.3h.8c-6.8 12.6-11 23.6-7.6 30.4z"
          />
        </g>
        <path
          id="brain_regions_svg__S1Shfill"
          className="brain_regions_svg__st6"
        ...
        />
        <path
          id="brain_regions_svg__S1HLfill"
          className="brain_regions_svg__st6"
      ...
      <g id="brain_regions_svg__Lines__x2B__text">
        <g id="brain_regions_svg__Brainregionslinestext">
          <path
            className="brain_regions_svg__st7"
          ...
          <g className="brain_regions_svg__st8">
            <path
              className="brain_regions_svg__st9"
...
export default SvgBrainRegions;
